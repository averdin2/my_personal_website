    ...
    <div id="projects" className="projects-container">
      ...
      <div className="inner-projects-container">
        <div className="project crookbook">
          <h2>CrookBook</h2>
          <p>
            A web application database to help the LAPD sort thier old murder
            case files.{' '}
          </p>
          <a href="https://github.com/evanhessler/CrookBook" className="button">
            See Code
          </a>
        </div>
        <div className="project covid">
          ...
          <div className="buttons">
            <a
              href="https://averdin2.github.io/Covid-19-data-charts/"
              className="button"
            >
              See Site
            </a>
            <a
              href="https://github.com/averdin2/Covid-19-data-charts"
              className="button"
            >
              See Code
            </a>
        ...
        <div className="project dodgers">
          ...
          <div className="buttons">
            <a
              href="https://averdin2.github.io/Dodgers_Scores/"
              className="button"
            >
              See Site
            </a>
            <a
              href="https://github.com/averdin2/Dodgers_Scores"
              className="button"
            >
              See Code
            </a>
        ...
        <div className="project mlb">
          ...
          <p>
            A website for stats of all current MLB players sorted by their team.{' '}
          </p>
          <div className="buttons">
        ...
        <div className="project paneljumper">
          <h2>Panel Jumper</h2>
          <p>
            A 2D infinite jumper game seeking to add a unique take to the genre.{' '}
          </p>
